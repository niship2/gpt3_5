    ...
    with st.container():
        with claims_inst_col:
            instruction_claims = st.text_area(
                '文章生成指示文を入力してください', value="特許文章らしい特許請求の範囲として修正してください。【請求項１】という見出しを加えて下さい。１文章で作成して下さい。【請求項2】を追加して、請求項2にはダイオード素子の種類を列挙してください。", placeholder="特許文章らしい特許請求の範囲を作成してください。【請求項１】という見出しを加えて下さい。１文章で作成して下さい。【請求項2】を追加して、請求項2にはダイオード素子の種類を列挙してください。")
